...
public class problem1 {
    ...
    public static void main(String[] args) {
        System.out.println(bin2Dec("100110"));
        System.out.println(bin2Dec("abcdefg"));
    }
    ...
    public static int bin2Dec(String binaryString) throws BinaryFormatException {
        ...
        for (int i = 0; i < binaryString.length(); i++) {
            ...
            // otherwise throw an exception
                ...
                throw new BinaryFormatException("The string is not a binary number");
            }
        }
...
class BinaryFormatException extends IllegalArgumentException {
    // create exception for if the string is not a binary string
